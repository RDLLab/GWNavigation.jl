function GWNavigationPOMDP(;grid_size::Int=20, danger_state_penalty::Float64=-100.0, goal_state_reward::Float64=200.0, step_penalty::Float64=-1.0, discount_factor::Float64=0.99)
    if grid_size == 20
        return get_20x20_gw_problem(danger_state_penalty=danger_state_penalty, goal_state_reward=goal_state_reward, step_penalty=step_penalty, discount_factor=discount_factor)
    elseif grid_size == 60
        return get_60x60_gw_problem(danger_state_penalty=danger_state_penalty, goal_state_reward=goal_state_reward, step_penalty=step_penalty, discount_factor=discount_factor)
    else
...
function GWNavigationPOMDP(
    ...
    observations_to_states = Dict{GWObservation, Set{GWState}}(GWTerminalObservation => Set{GWState}([GWTerminalState]))
    obs_idx = 3
...
function get_20x20_gw_problem(;danger_state_penalty::Float64=-100.0, goal_state_reward::Float64=200.0, step_penalty::Float64=-1.0, discount_factor::Float64=0.99)
    ...
    return GWNavigationPOMDP(
        ...
        goals_20x20,
        init_states_20x20;
        danger_state_penalty=danger_state_penalty,
...
function get_60x60_gw_problem(;danger_state_penalty::Float64=-100.0, goal_state_reward::Float64=200.0, step_penalty::Float64=-1.0, discount_factor::Float64=0.99)

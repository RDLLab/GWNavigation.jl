function GWNavigationPOMDP(;grid_size::Int=20, danger_state_penalty::Float64=-100.0, goal_state_reward::Float64=200.0, step_penalty::Float64=-1.0)
    if grid_size == 20
        return get_20x20_gw_problem(danger_state_penalty=danger_state_penalty, goal_state_reward=goal_state_reward, step_penalty=step_penalty)
    elseif grid_size == 60
        return get_60x60_gw_problem(danger_state_penalty=danger_state_penalty, goal_state_reward=goal_state_reward, step_penalty=step_penalty)
    else
...
function get_20x20_gw_problem(;danger_state_penalty::Float64=-100.0, goal_state_reward::Float64=200.0, step_penalty::Float64=-1.0)
...
function get_60x60_gw_problem(;danger_state_penalty::Float64=-100.0, goal_state_reward::Float64=200.0, step_penalty::Float64=-1.0)
